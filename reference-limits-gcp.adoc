...
. FlexVol volume creation up to the maximum size of 300 TiB is supported using System Manager and the ONTAP CLI starting from Cloud Volumes ONTAP 9.12.1 P2 and 9.13.0 P2.
